  ...
  return (
    <BaseModal title="How to play 遊び方" isOpen={isOpen} handleClose={handleClose}>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300 pb-2">
        Answer <span className="local-font">答え「あげだし」</span>
      </p>
      <p className="text-left text-sm text-gray-500 dark:text-gray-300 pb-2">
      ...
      <p className="local-font text-lg leading-6 font-medium text-gray-900 dark:text-gray-100 mt-4">
        Hint Mode ヒントモード
      </p>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-300 pb-2">
        Answer <span className="local-font">答え「にっこう」</span>
      </p>
      <p className="text-left text-sm text-gray-500 dark:text-gray-300 pb-2">
